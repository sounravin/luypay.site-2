    ...
    return (
      <div className="min-h-screen bg-[#030712] flex flex-col antialiased font-sans relative overflow-hidden">
        ...
        <div className="flex-1 flex flex-col justify-center items-center p-4 relative z-10 my-auto">
          ...
          {/* Fast Direct Login Card */}
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
            className="w-full max-w-md bg-slate-900/80 backdrop-blur-xl border border-slate-800/80 rounded-2xl sm:rounded-3xl p-6 sm:p-8 shadow-[0_20px_50px_rgba(0,0,0,0.6)] space-y-5 sm:space-y-6 relative overflow-hidden"
          >
