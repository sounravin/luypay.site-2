...
export const THEMES: Record<AppThemeType, ThemeConfig> = {
  slate: {
    ...
    sidebarClass: 'bg-slate-900 text-white border-slate-800/80',
    cardClass: 'bg-white dark:bg-slate-900 border-slate-200 dark:border-slate-800 shadow-sm',
    inputClass: 'bg-slate-50 dark:bg-slate-950 border-slate-200 dark:border-slate-800 text-slate-800 dark:text-slate-100 focus:ring-blue-500/20 focus:border-blue-500',
    textMuted: 'text-slate-500 dark:text-slate-400',
    textTitle: 'text-slate-800 dark:text-slate-200',
